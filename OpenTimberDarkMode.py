...
class OpenTimber:
    def __init__(self, root):
        ...
        self.root.configure(bg="#131727")

        # Frame for formula-specific content at the top
        self.content_frame = tk.Frame(self.root, bg="#131727")
        self.content_frame.pack(fill=tk.X, padx=20, pady=20)

        # Container for results, centered under content
        self.results_container = tk.Frame(self.root, bg="#131727")
        self.results_container.pack(pady=(0, 10))

        # Scrollable canvas for results
        self.results_canvas = tk.Canvas(self.results_container, width=600, height=200, bg="#131727", highlightthickness=0)
        ...
        self.results_frame = tk.Frame(self.results_canvas, bg="#131727")
    ...
    def show_huber_ui(self):
        ...
        top_frame = tk.Frame(self.content_frame, bg="#131727")
